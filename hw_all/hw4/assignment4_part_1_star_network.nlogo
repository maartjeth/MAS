...
extensions [ nw nw]
; now you can use: nw:generate-star turtles links 100 [ set color red ]  ; experimental example of Romy xD
...
globals [total_dirty time x_end y_end clean_all all_sensors coordinate turtle_patches]
...
to setup-vacuums
  ...
  ;nw:generate-star vacuums links vision_radius [ set color red ]
  ask vacuums [
    ...
    set all_sensors lput coordinate all_sensors
    ;print all_sensors
    ask patches in-radius  (vision_radius / 2) [
      set pcolor blue
      set coordinate (list pxcor pycor)
      set all_sensors lput coordinate turtle_patches


    ;]
    print all_sensors

    ;set all_sensors [ask patches in-radius (vision_radius / 2) ]
